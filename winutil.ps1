...
################################################################################################################
###                                                                                                          ###
### WARNING: This file is automatically generated DO NOT modify                                        (SRC) ###
###                                                                                                          ###
################################################################################################################
...
$inputXML = '<Window x:Class="WinUtility.MainWindow"
        ...
        Title="SRC Windows Utility" Height="800" Width="1200">
        ...
        <Viewbox Stretch="Uniform" VerticalAlignment="Top">
            <Grid Background="{MainBackgroundColor}" ShowGridLines="False" Name="WPFMainGrid">
                ...
                <DockPanel Background="{MainBackgroundColor}" SnapsToDevicePixels="True" Grid.Row="0" Width="1100">
                    <Image Height="100" Width="150" Name="WPFIcon" SnapsToDevicePixels="True" Source="https://itbysrc.com/wp-content/uploads/2022/04/SRC.png" Margin="0,10,0,10"/>
                    ...
                    <TabItem Header="Tweaks" Visibility="Collapsed" Name="WPFTab2">
                        <Grid Background="#333333">
							...
							<Label Content="Shortcuts" />
                                <Button Name="WPFWinUtilShortcut" Content="Create a Shortcut to this App" HorizontalAlignment = "Left" Margin="5,0" Padding="20,5" Width="300"/>
...
$sync.configs.themes = '{
    "Classic":  {
                   ...
                   "ComboBoxForegroundColor":  "#ffffff",
