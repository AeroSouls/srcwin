        ...
        <Viewbox Stretch="Uniform" VerticalAlignment="Top">
            <Grid Background="{MainBackgroundColor}" ShowGridLines="False" Name="WPFMainGrid">
                ...
                <DockPanel Background="{MainBackgroundColor}" SnapsToDevicePixels="True" Grid.Row="0" Width="1100">
                    <Image Height="50" Width="50" Name="WPFIcon" SnapsToDevicePixels="True" Source="https://itbysrc.com/wp-content/uploads/2022/03/gaming-21.png" Margin="0,10,0,10"/>
                    ...
                    <TabItem Header="Install" Visibility="Collapsed" Name="WPFTab1">
                        <Grid Background="#222222">
                            ...
                            <StackPanel Background="{MainBackgroundColor}" SnapsToDevicePixels="True" Grid.Row="1" Grid.Column="3" Margin="10">
                                ...
                                <CheckBox Name="WPFInstallmicrosoftsysinternalsautoruns" Content="AutoRuns"Margin="5,0"/>
                            </StackPanel>
...
$sync.configs.applications = '{
	...
	"WPFInstallmicrosoftsysinternalsautoruns": {
		"winget": "Microsoft.Sysinternals.Autoruns",
		"choco": "Microsoft-Sysinternals-Autoruns"
	},
	"WPFInstallaudacity": {
